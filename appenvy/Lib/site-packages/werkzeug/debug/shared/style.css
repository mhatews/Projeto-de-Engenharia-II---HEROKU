...
div.traceback pre:hover { background-color: #DDECEE; color: black; cur: pointer; }
...
div.traceback img:hover { background-color: #ddd; cur: pointer;
                          border-color: #BFDDE0; }
...
pre.console { border: 1px solid #ccc; background: white!important;
              ...
              margin: 3px 0 0 0!important; cur: default!important;
...
pre.console div.traceback pre:hover { cur: default; background: #E8EFF0; }
...
pre.console div.box pre.help:hover { cur: default; }
