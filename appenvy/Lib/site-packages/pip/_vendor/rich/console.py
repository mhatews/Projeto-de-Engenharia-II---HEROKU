...
class ScreenContext:
    ...
    def __init__(
        self, console: "Console", hide_cur: bool, style: StyleType = ""
    ) -> None:
        self.console = console
        self.hide_cur = hide_cur
    ...
    def __enter__(self) -> "ScreenContext":
        ...
        if self._changed and self.hide_cur:
            self.console.show_cur(False)
        return self
...
class Console:
    ...
    def clear(self, home: bool = True) -> None:
        ...
        Args:
            home (bool, optional): Also move the cur to 'home' position. Defaults to True.
        """
        if home:
    ...
    def show_cur(self, show: bool = True) -> bool:
        """Show or hide the cur.

        Args:
            show (bool, optional): Set visibility of the cur.
        """
        if self.is_terminal and not self.legacy_windows:
            self.control(Control.show_cur(show))
            return True
        return False
    ...
    def screen(
        self, hide_cur: bool = True, style: Optional[StyleType] = None
    ) -> "ScreenContext":
        """Context manager to enable and disable 'alternative screen' mode.

        Args:
            hide_cur (bool, optional): Also hide the cur. Defaults to False.
            style (Style, optional): Optional style for screen. Defaults to None.

        Returns:
            ~ScreenContext: Context which enables alternate screen on enter, and disables it on exit.
        """
        return ScreenContext(self, hide_cur=hide_cur, style=style or "")
    ...
    def control(self, *control: Control) -> None:
        ...
        Args:
            control_codes (str): Control codes, such as those that may move the cur.
        """
